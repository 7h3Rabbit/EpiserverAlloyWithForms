...
namespace EpiserverAlloyWithForms.Business.Initialization
{
    ...
    public class StaticWebMessageInjectionDemoInitialization : IInitializableModule
    {
        ...
        private void OnAfterGetPageContent(object sender, StaticWebEpiserverPlugin.Events.StaticWebGeneratePageEventArgs e)
        {
            ...
            var warningsMessage = "<div class=\"container navbar-fixed-bottom\"><div class=\"row\"><div class=\"alert alert-warning\" role=\"alert\">You are currently viewing a limited version of our website. One of the reasons for this could be because we currently have an abnormal amount of traffic.</div></div></div><br><br><br><br></body>";
